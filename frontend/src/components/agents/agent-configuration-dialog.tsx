...
interface AgentConfigurationDialogProps {
  ...
  agentId: string;
  initialTab?: 'instructions' | 'tools' | 'integrations' | 'knowledge' | 'triggers' | 'files';
                    ...
                    {isSunaAgent && (
                      <Alert className="mb-4 bg-blue-50 border-blue-200 dark:bg-blue-950/20 dark:border-blue-900">
                        ...
                        <AlertDescription className="text-sm text-blue-800 dark:text-blue-300">
                          You can't edit Omni, but you can create a new AI Agent that you can modify as you wish.
                        </AlertDescription>
                      </Alert>
                    )}
