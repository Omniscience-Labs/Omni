...
interface AgentConfigurationDialogProps {
  ...
  agentId: string;
  initialTab?: 'instructions' | 'tools' | 'integrations' | 'knowledge' | 'default-files' | 'triggers';
...
export function AgentConfigurationDialog({
  ...
  const isSystemPromptEditable = !isViewingOldVersion && (restrictions.system_prompt_editable !== false) && !isOmniAgent;
  const areToolsEditable = !isViewingOldVersion && (restrictions.tools_editable !== false) && !isOmniAgent;
                              ...
                              {agents.map((agent: any) => (
                                ...
                                >
                                  <AgentAvatar
                                    ...
                                    isOmniDefault={agent.metadata?.is_suna_default}
                                    size={24}
                                    className="flex-shrink-0"
                                  />
          ...
          {isLoading ? (
            ...
            <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as typeof activeTab)} className="flex-1 flex flex-col min-h-0">
              ...
              <div className="flex-1 overflow-auto">
                    ...
                    {isOmniAgent && (
                      <Alert className="mb-4 bg-blue-50 border-blue-200 dark:bg-blue-950/20 dark:border-blue-900">
                        ...
                        <AlertDescription className="text-sm text-blue-800 dark:text-blue-300">
                          You can't edit the main OMNI Super Worker, but you can create a new AI Worker that you can modify as you wish.
                        </AlertDescription>
                      </Alert>
                    )}
                ...
                <TabsContent value="default-files" className="p-6 mt-0 flex flex-col h-full">
                  <div className="flex flex-col flex-1 min-h-0 h-full relative">
                    <AgentDefaultFilesConfiguration agentId={agentId} />
                    {isFreeTier && (
                      <div className="absolute inset-0 z-10">
                        <div className="absolute inset-0 bg-background/80 backdrop-blur-sm" />
                        <div className="relative h-full flex flex-col items-center justify-center px-8">
                          ...
                          >
                            <div className="flex flex-col items-center text-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                  Attach files by default when starting a chat so your AI Workers always have the right context
                                </p>
                              </div>
                              <Button 
                                variant="default"
