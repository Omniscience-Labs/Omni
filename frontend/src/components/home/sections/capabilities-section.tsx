...
const capabilities = [
  ...
  },
  {
    ...
    description: 'Omni never sleeps. Schedule tasks to run overnight, on weekends, or whenever you need work done without being there.',
        ...
        <div className="max-w-6xl mx-auto border-l border-r border-border">
          <SectionHeader>
            ...
            <p className="text-muted-foreground text-center text-balance font-medium">
              From content creation to data analysis, Omni handles the work that takes you hours in just minutes.
            </p>
          </SectionHeader>
