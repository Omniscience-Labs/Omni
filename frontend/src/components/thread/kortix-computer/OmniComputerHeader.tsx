...
interface OmniComputerHeaderProps {
...
/**
 * Shared header component for all Omni Computer views (Files, File Viewer, Browser).
 ...
 */
export function OmniComputerHeader({
  icon: Icon,
  onIconClick,
  iconTitle,
  title,
