...
export default function ContributingPage() {
  return (
    <>
      <DocsHeader
        title="Contributing to Omni"
        description="Help make Omni better for everyone! We welcome contributions from the community"
      ...
      <section className="mb-12">
        ...
        <DocsBullets variant="check" spacing="default" className="mb-8">
          <DocsBulletItem
            ...
            description="Create your own fork of the Omni repository on GitHub"
          />
          <DocsBulletItem
            title="Clone Locally"
      ...
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            There are many ways to help improve Omni:
          </p>
        </DocsBody>
