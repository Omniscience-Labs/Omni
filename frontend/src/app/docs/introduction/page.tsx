  ...
  return (
    <>
      ...
      <DocsBody className="mb-8">
        <h2 id="overview">What is Omni?</h2>
        <p className="text-lg mb-6">
          Omni is an open source platform where you can build AI agents that handle real work. Think of it as the infrastructure and tools you need to create agents that can browse the web, manage files, analyze data, and automate workflows.
        </p>
        
        <h3 id="meet-omni">Omni - Our Flagship Agent</h3>
        <p className="mb-4">
          Omni is our showcase agent that demonstrates what's possible with Omni. It's a generalist AI worker that can:
        </p>
