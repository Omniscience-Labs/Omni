...
export default function ArchitecturePage() {
  return (
    <>
      <DocsHeader
        title="Platform Architecture"
        subtitle="Understanding the core components and design of the Omni platform"
      ...
      <section id="architecture" className="mb-16">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            Omni consists of four main components that work together to provide a complete AI agent development platform:
          </p>
        </DocsBody>
      ...
      <section id="tech-stack" className="mb-16">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            Modern technologies powering the Omni platform:
          </p>
        </DocsBody>
      ...
      <section id="data-flow" className="mb-16">
        <DocsBody className="mb-8">
          <h2>🔄 Data Flow</h2>
          <p className="text-lg mb-6">
            How information moves through the Omni platform:
          </p>
