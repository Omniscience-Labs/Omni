                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        Omni AI Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        ...
                        <li>
                          ...
                          Company, specifically legal@Omni.com
                        </li>
                        <li>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to info@Omni.com and we will process and
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        or by emailing us at info@Omni.com. If you cancel
