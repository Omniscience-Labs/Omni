...
# Subscription tier IDs - Production
    ...
    STRIPE_TIER_2_20_ID_PROD: Optional[str] = 'price_1S7ibVRGnNhiCsluStxGPsPT'
    STRIPE_TIER_6_50_ID_PROD: str = 'price_1S7ibVRGnNhiCslujX0nuAnS'
    STRIPE_TIER_12_100_ID_PROD: Optional[str] = None
    STRIPE_TIER_25_200_ID_PROD: str = 'price_1S7ibVRGnNhiCslub6EBP6fo'
    STRIPE_TIER_50_400_ID_PROD: Optional[str] = None
    STRIPE_TIER_125_800_ID_PROD: Optional[str] = None
    STRIPE_TIER_200_1000_ID_PROD: Optional[str] = None
    ...
    STRIPE_TIER_12_100_YEARLY_ID_PROD: Optional[str] = None
    STRIPE_TIER_25_200_YEARLY_ID_PROD: str = 'price_1S7ibVRGnNhiCsluh23GQqnG'  # $2040/year
    STRIPE_TIER_50_400_YEARLY_ID_PROD: Optional[str] = None
    STRIPE_TIER_125_800_YEARLY_ID_PROD: Optional[str] = None
    STRIPE_TIER_200_1000_YEARLY_ID_PROD: Optional[str] = None

    # Yearly commitment prices - Production (15% discount, monthly payments with 12-month commitment via schedules)
    STRIPE_TIER_2_17_YEARLY_COMMITMENT_ID_PROD: Optional[str] = None
    STRIPE_TIER_6_42_YEARLY_COMMITMENT_ID_PROD: Optional[str] = None
    STRIPE_TIER_25_170_YEARLY_COMMITMENT_ID_PROD: Optional[str] = None
    ...
    STRIPE_TIER_12_100_ID_STAGING: Optional[str] = None
    STRIPE_TIER_25_200_ID_STAGING: str = 'price_1S7jV3RGnNhiCsluip3seDaW'
    STRIPE_TIER_50_400_ID_STAGING: Optional[str] = None
    STRIPE_TIER_125_800_ID_STAGING: Optional[str] = None
    STRIPE_TIER_200_1000_ID_STAGING: Optional[str] = None
    
    # Yearly subscription tier IDs - Staging (15% discount)
    STRIPE_TIER_2_20_YEARLY_ID_STAGING: str = 'price_1S7jVbRGnNhiCslug83mGCUN'
    STRIPE_TIER_6_50_YEARLY_ID_STAGING: str = 'price_1S7jVkRGnNhiCsluaHTHKO9b'
    STRIPE_TIER_12_100_YEARLY_ID_STAGING: Optional[str] = None
    STRIPE_TIER_25_200_YEARLY_ID_STAGING: str = 'price_1S7jVtRGnNhiCsluBwmAztkE'
    STRIPE_TIER_50_400_YEARLY_ID_STAGING: Optional[str] = None
    STRIPE_TIER_125_800_YEARLY_ID_STAGING: Optional[str] = None
    STRIPE_TIER_200_1000_YEARLY_ID_STAGING: Optional[str] = None

    # Yearly commitment prices - Staging (Same as Upfront Annual)
    STRIPE_TIER_2_17_YEARLY_COMMITMENT_ID_STAGING: str = STRIPE_TIER_2_20_YEARLY_ID_STAGING
    STRIPE_TIER_6_42_YEARLY_COMMITMENT_ID_STAGING: str = STRIPE_TIER_6_50_YEARLY_ID_STAGING
    STRIPE_TIER_25_170_YEARLY_COMMITMENT_ID_STAGING: str = STRIPE_TIER_25_200_YEARLY_ID_STAGING
