...
@tool_metadata(
    ...
    description="Convert PDF pages to images for viewing and analysis with the Image Vision tool",
    icon="FileImage",
...
class SandboxPdfToImagesTool(SandboxToolsBase):
    """Converts a PDF in the sandbox to one image per page, saved under uploads/pdf_images/."""
...
The images are saved under uploads/pdf_images/<pdf_basename>_page_1.png (or .jpg). You can then call load_image on up to 3 of these paths at a time to add them to context for the LLM.
