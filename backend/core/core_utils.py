...
async def generate_and_update_project_name(project_id: str, prompt: str):
    ...
    try:
        ...
        response = await make_llm_api_call(
            ...
            stream=False  # Need non-streaming response for JSON parsing
        )
...
# Note: check_agent_run_limit, check_agent_count_limit, and check_project_count_limit
# are imported from .utils.limits_checker above - no need to redefine them here
