...
from core.tools.sb_pdf_to_image_tool import SandboxPdfToImageTool
...
class ToolManager:
    ...
    def _register_sandbox_tools(self, disabled_tools: List[str]):
        ...
        sandbox_tools = [
            ...
            ('sb_pdf_to_image_tool', SandboxPdfToImageTool, {'project_id': self.project_id, 'thread_manager': self.thread_manager}),
...
class AgentRunner:
    ...
    def _get_disabled_tools_from_config(self) -> List[str]:
        ...
        all_tools = [
            ...
            'sb_sheets_tool', 'sb_web_dev_tool', 'sb_pdf_to_image_tool', 'data_providers_tool', 'browser_tool',
