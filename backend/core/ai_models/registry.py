...
>>>>>>> ddb72cfa (Now using Sonnet 4.6 as POWER, 4.5 as fallback and enabled 1M context window for POWER)
                return _POWER_MODEL_ID
=======
                return _get_power_model_id()
>>>>>>> db002ff3 (Bug fix in bedrock ARNs)
            return model.id
...
>>>>>>> db002ff3 (Bug fix in bedrock ARNs)
        ...
        if "haiku" in lid_lower:
            return "kortix/basic"
>>>>>>> 1771619c (Added Anthropic fallbacks)
