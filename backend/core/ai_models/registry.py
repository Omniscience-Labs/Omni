...
DEFAULT_FREE_MODEL = "Claude Sonnet 4.6"
DEFAULT_PREMIUM_MODEL = "Claude Sonnet 4.6"
...
class ModelRegistry:
    ...
    def _initialize_models(self):
        self.register(Model(
            ...
            aliases=["claude-sonnet-4-6", "anthropic/claude-sonnet-4-6", "Claude Sonnet 4.6", "claude-sonnet-4-6-20250514"],
