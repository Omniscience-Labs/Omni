...
class TriggerService:
    ...
    def _map_to_trigger(self, data: Dict[str, Any]) -> Trigger:
        ...
        # Read provider_id from column if it exists, otherwise from config for backwards compatibility
        ...
        # Clean config - remove provider_id if it exists there (will be in column after migration)
