...
- Supports all models: Claude 3.7 (200k), Claude Sonnet 4.6 (1M), Gemini 2.5 Pro (2M)
...
| 1M tokens | 1.5x | Claude Sonnet 4.6 |
...
| **Claude Sonnet 4.6** | 1M | 7.5k tokens | 15k tokens | 25k tokens | 45k tokens |
