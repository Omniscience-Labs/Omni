-- 2. Ensure atomic_reset_expiring_credits exists (original: 20251015063446)
-- NOTE: Must be in its own migration due to Supabase CLI bug #4746 -
-- the parser misinterprets "atomic" in identifiers as BEGIN ATOMIC and merges statements.
